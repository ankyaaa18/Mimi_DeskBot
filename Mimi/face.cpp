...
void cheeks()
{
    ...
    // Left cheek
    display.drawLine(ex + 8 + 2 + 2, ey + eyeHeight + 1, ex + 10 + 2 + 2, ey + eyeHeight + 3 + 1, SSD1306_WHITE);
    display.drawLine(ex + 12 + 2 + 2, ey + eyeHeight + 1, ex + 14 + 2 + 2, ey + eyeHeight + 3 + 1, SSD1306_WHITE);
    display.drawLine(ex + 16 + 2 + 2, ey + eyeHeight + 1, ex + 18 + 2 + 2, ey + eyeHeight + 3 + 1, SSD1306_WHITE);
    display.drawLine(ex + 20 + 2 + 2, ey + eyeHeight + 1, ex + 22 + 2 + 2, ey + eyeHeight + 3 + 1, SSD1306_WHITE);
    display.drawLine(ex + 24 + 2 + 2, ey + eyeHeight + 1, ex + 26 + 2 + 2, ey + eyeHeight + 3 + 1, SSD1306_WHITE);
    display.drawLine(ex + 28 + 2 + 2, ey + eyeHeight + 1, ex + 30 + 2 + 2, ey + eyeHeight + 3 + 1, SSD1306_WHITE);
 
    // Right cheek
    display.drawLine(ex + 98 - 2 - 2, ey + eyeHeight + 1, ex + 102 - 2 - 3, ey + eyeHeight + 3 + 1, SSD1306_WHITE);
    display.drawLine(ex + 102 - 2 - 2, ey + eyeHeight + 1, ex + 104 - 2 - 2, ey + eyeHeight + 3 + 1, SSD1306_WHITE);
    display.drawLine(ex + 106 - 2 - 2, ey + eyeHeight + 1, ex + 108 - 2 - 2, ey + eyeHeight + 3 + 1, SSD1306_WHITE);
    display.drawLine(ex + 110 - 2 - 2, ey + eyeHeight + 1, ex + 112 - 2 - 2, ey + eyeHeight + 3 + 1, SSD1306_WHITE);
    display.drawLine(ex + 114 - 2 - 2, ey + eyeHeight + 1, ex + 116 - 2 - 2, ey + eyeHeight + 3 + 1, SSD1306_WHITE);
    display.drawLine(ex + 118 - 2 - 2, ey + eyeHeight + 1, ex + 120 - 2 - 2, ey + eyeHeight + 3 + 1, SSD1306_WHITE);
}
...
void drawEyes(int blinkAmount)
{
    ...
    display.fillRoundRect(lx, y, w, h, dynamicRadius, SSD1306_WHITE);
    display.fillRoundRect(rx, y, w, h, dynamicRadius, SSD1306_WHITE);
...
static void renderNeutralFace()
{
    ...
    display.fillRoundRect(lx, ly, w, lHeight, dynamicRadius, SSD1306_WHITE);
    display.fillRoundRect(rx, ry, w, rHeight, dynamicRadius, SSD1306_WHITE);
...
static void drawHappySquintEye(int centerX, int centerY)
{
    ...
    display.fillRect(cutX, cutY, cutW, cutH, SSD1306_BLACK);
}
...
static void drawHappySmile()
{
    ...
    display.fillRect(cx - r - 4, cy - r - 4, 2 * r + 8, r + 4, SSD1306_BLACK);
}
